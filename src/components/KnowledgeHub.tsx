...
import { Database, FileText, User, Search, Plus, Trash2, Tag, Calendar, Building2, Mail, GraduationCap, X, ShieldCheck, AlertCircle, BarChart3, LayoutTemplate, Download } from 'lucide-react';
